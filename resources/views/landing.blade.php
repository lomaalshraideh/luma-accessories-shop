            ...
            <div class="row">
                <div class="open-up" data-aos="zoom-out">
                    <div class="img-bg text-center">
                        <img src="{{ asset('assets/images/landing page.jpg') }}" alt="Image" class=" img-fluid rounded shadow">
                    </div>
                </div>
            </div>
        </div>
              ...
              <div class="cat-item image-zoom-effect">
                <div class="image-holder">
                  <a href="{{ url('category/' . $category->id) }}">
                    <img src="{{ asset('storage/' . $category->image) }}" alt="{{ $category->name }}" class="product-image img-fluid">
                  </a>
                </div>
                <div class="category-content">
                  <div class="product-button">
                    <a href="{{ url('category/' . $category->id) }}" class="btn btn-common text-uppercase">
                      {{ $category->name }}
                    </a>
                  </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="testimonial-item text-center">
                        <blockquote>
                            ...
                            <div class="review-title text-uppercase">{{ $testimonial->name }}</div>
                            ...
                            @if($testimonial->image)
                                <div class="mt-3">
                                    <img src="{{ asset('storage/' . $testimonial->image) }}" alt="{{ $testimonial->name }}"
                                         class="rounded-circle shadow" width="70" height="70">
                                </div>
                            @endif
                        </blockquote>
                    </div>
